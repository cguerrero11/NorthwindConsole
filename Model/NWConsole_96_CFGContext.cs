...
{
    public partial class NWConsole_96_CFGContext : DbContext
    {
        public NWConsole_96_CFGContext()
        {
        }

        public NWConsole_96_CFGContext(DbContextOptions<NWConsole_96_CFGContext> options)
            : base(options)
        {
        }
